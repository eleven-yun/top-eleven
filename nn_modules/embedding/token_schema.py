...
# Indices 0-15:  original 16 team-stat tokens
# Indices 16-31: Sprint A extended form tokens (8 per side)
# Indices 32-34: Sprint A gap tokens (neutral side)
# Indices 35-40: market tokens (unchanged)
# Indices 41-45: Sprint B schedule/fatigue tokens (2 per-side pairs + 1 gap)
TOKEN_NAMES = [
    # --- original team stats (indices 0-15) ---
    ...
    # --- Sprint A: extended form per team (indices 16-31) ---
    ...
    # --- Sprint A: gap features (indices 32-34, neutral side) ---
    "elo_gap",
    "points_gap_last_5",
    "goal_diff_gap_last_5",
    # --- market tokens (indices 35-40) ---
    "odds_fulltime_home",
    "odds_fulltime_draw",
    "odds_fulltime_away",
    "handicap_line",
    "odds_handicap_home",
    "odds_handicap_away",
    # --- Sprint B: schedule / fatigue (indices 41-45) ---
    "home_rest_days",
    "away_rest_days",
    "home_congestion_14d",
    "away_congestion_14d",
